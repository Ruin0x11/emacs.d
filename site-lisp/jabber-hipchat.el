...
(defcustom hipchat-nickname "Ian Pickering" "Hipchat real name (see see https://hipchat.com/account/xmpp)."
  :type '(string)
  :group 'hipchat)
...
(defcustom hipchat-api-key "xY4l89NXouNWv7gCmpFZRB9klJMOvry8pI1RQr9m" "API key for hipchat.
