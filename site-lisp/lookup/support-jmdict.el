...
(defvar support-jmdict-delete-tags
  '("<gloss xml"
    "<bib_txt>"
    "<etym>"
    "<ent_seq>"
...
(defvar support-jmdict-delete-tags-regexp
  (regexp-opt support-jmdict-delete-tags))
...
(defun support-jmdict-arrange-structure (entry)
  ...
  (goto-char (point-min))
  (while (re-search-forward support-jmdict-delete-tags-regexp nil t)
